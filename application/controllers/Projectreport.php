<?php
	...
	class Projectreport extends ADMIN_CONTROLLER{
		...
		public function dailyBAReport($id){
			...
			$this->load->view('project/reports/beauty_agent_daily_report', $this->data);
		}
		...
		public function dailySupervisorReport($id){
			...
			$this->load->model('dto/Dtouser');
			$this->data["supervisor_users"] = $this->Daouser->getAllUsersByGroupId(2);
			$this->load->view('project/reports/supervisor_daily_report', $this->data);
		}
		...
		public function dailyGMReport($id){
			...
			$this->load->view('project/reports/beauty_executive_daily_report',$this->data);
		}
