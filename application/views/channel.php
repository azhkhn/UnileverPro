                   ...
                   <?php foreach ($lists as $data ) {
                    ...
                    ?>  
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url()?>channel/getpro/<?php echo $data->id ?>" data-uk-tooltip="{pos:'left'}" title="Edit"><i class="md-icon material-icons">edit</i></a>
                                <a href="<?php echo site_url()?>channel/deletepro/<?php echo $data->id ?>" onclick="return confirm('Do you want to delete?');" data-uk-tooltip="{pos:'left'}" title="Delete"><i class="md-icon material-icons">delete</i></a>
                            </td>
                        </tr>
