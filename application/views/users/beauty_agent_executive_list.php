...
<body>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-1-1">
                            <div class="uk-overflow-container">
                                <table id="BAExecutive_table" class="uk-table" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Image</th>
                                            <th>Full Name</th>
    ...
    <div>
        <div class="uk-modal" id="modalBAExecutiveAddNew">
            <div class="uk-modal-dialog uk-modal-dialog-large">
                <button type="button" class="uk-modal-close uk-close"></button>
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">REGISTER A NEW BA's EXECUTIVE</h3>
                </div>
                <form action="" class="uk-form-stacked" id="frmBAExecutiveAddNew" method="POST">
                                    ...
                                    <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                        <div class="uk-width-large-1-2">
                                            ...
                                            <div class="uk-form-row">
                                                ...
                                                <input type="text" class="md-input" name="txtTelephone" id="txtTelephone" required value=""/>
                                            </div>
                                        ...
                                        <div class="uk-width-large-1-2">
                                            ...
                                            <div class="uk-form-row">
                                                ...
                                                <input type="password" class="md-input" id="txtPassword" name="txtPassword" required value=""/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label for="product_edit_memory_control" class="uk-form-label">Confirmation Password<span class="req">*</span></label>
                                                <input type="password" class="md-input" id="txtConfirmationPassword" name="txtConfirmationPassword" required value=""/>
                                            </div>
                                            
                                            <div class="uk-form-row">
                                                <div class="md-input-wrapper md-input-filled">
                                                    <label for="validOfDate" class="uk-form-label">Start Working<span class="req">*</span></label>
                                                    <input class="md-input" type="text" id="startWorking" name="startWorking" data-uk-datepicker="{format:'DD/MMMM/YYYY'}" required>
                                                </div>
                                            </div>
                                            <div class="uk-form-row">
                ...
                <div class="uk-modal-footer uk-text-right">
                    <button type="button" class="md-btn md-btn-default uk-modal-close">Close</button>
                    <input type="button" class="md-btn md-btn md-btn-primary" data='' id="btnUpdateSave" value="Update" style="display:none;"/>
                    <input type="submit" class="md-btn md-btn md-btn-primary" id="btnSave" value="Save" />
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-primary" href="#" id="btnOpenAddNew" data-uk-modal="{target:'#modalBAExecutiveAddNew'}">
