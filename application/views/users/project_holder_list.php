...
<body>
    ...
    <div id="page_content">
        <div id="page_heading">
            <h1 id="product_edit_name">PROJECT HOLDER INFORMATIONS</h1>
        </div>
    ...
    <div>
        <div class="uk-modal" id="modalAddNew">
            <div class="uk-modal-dialog uk-modal-dialog-large">
                <button type="button" class="uk-modal-close uk-close"></button>
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">REGISTER A NEW PROJECT HOLDER</h3>
                </div>
                <form action="" class="uk-form-stacked" id="frmAddNew">
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-primary" href="#" id="btnOpenAddNew" data-uk-modal="{target:'#modalAddNew'}">
