...
<body>
    ...
    <div id="page_content">
        <div id="page_heading">
            <h1 id="product_edit_name">OUTLET & PRODUCT TOTAL QUANTITY MONTHLY</h1>
        </div>
    ...
    <script type="text/javascript">
        $(function(){
            $("#btnExportExcel").click(function(){
                location.href=SITE_URL+"outletexcel/outlet_quantity_ajax/"+$("#selectYear").val();
            });
        });
    </script>
    <script type="text/javascript">
        $(function(){
            ...
            excel.getAllProducts = function(year){
                ...
                $.ajax({
                    url: SITE_URL+'outletexcel/outlet_quantity_ajax/'+ year,
                    type: "POST",
                    dataType: "JSON",
