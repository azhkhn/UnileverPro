$(function(){
	...
	$("#selectedBA").change(function(){
		...
		$.ajax({
			url: SITE_URL+'saletransaction/changeba',
			type: "POST",
			dataType: "JSON",
			data: {
			...
			success: function(data){
				...
				if(data.user){
					...
					sales.getAllSales(SITE_URL+"saletransaction/ajax");
				}
				modal.hide();
			},
			error: function(data){
	...
	$("#txtDMSCode").keyup(function(e){
    	...
    	if (code==13) {
			...
			modal = UIkit.modal.blockUI("<div class='uk-text-center'>Processing...<br/><img class='uk-margin-top' src='"+SITE_URL+"public/assets/img/spinners/spinner.gif' alt=''"); 
			$.ajax({
				url: SITE_URL+'saletransaction/changedmsCode',
				type: "POST",
				dataType: "JSON",
				data: {
	...
	$(document).on('click',"#btnDelete", function(e){
		if(confirm("Do you really want to delete it?")){
			...
			modal = UIkit.modal.blockUI("<div class='uk-text-center'>Processing...<br/><img class='uk-margin-top' src='"+SITE_URL+"public/assets/img/spinners/spinner.gif' alt=''"); 
			$.ajax({
				url: SITE_URL+"saletransaction/deleteSale",
				type: "POST",
				dataType: "JSON",
				data: {
	...
	$("#txtQuantitySold").change(function(){
		...
		modal = UIkit.modal.blockUI("<div class='uk-text-center'>Processing...<br/><img class='uk-margin-top' src='"+SITE_URL+"public/assets/img/spinners/spinner.gif' alt=''"); 
		$.ajax({
			url: SITE_URL+"saletransaction/checkpromotion",
			type: "POST",
			dataType: "JSON",
			data: {
	...
	$(document).on('click', "#btnSave", function(e){
		...
		modal = UIkit.modal.blockUI("<div class='uk-text-center'>Processing...<br/><img class='uk-margin-top' src='"+SITE_URL+"public/assets/img/spinners/spinner.gif' alt=''"); 
		$.ajax({
			url: SITE_URL+"saletransaction/updatesale",
			type: "POST",
			dataType: "JSON",
			data: {
