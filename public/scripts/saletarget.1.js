...
//								oldname			   	 : $.trim($("#oldname").val()),
	   ...
	   schema: {
	       model: {
	         ...
	         fields: {
	            ...
	            start_date: { editable: true, nullable: false, type: "date"},
	            end_date: { editable: true, nullable: false, type: "date"}
	         },
	...
	function dateTimeEditor(container, options) {
		//$('<input class="md-input" data-text-field="' + options.field + '" value="' + options.field + '" value="'+options.field + ' type="text" id="txtTransactionOfsaleTransactionHistory" data-uk-datepicker="{format:\'DD-MMMM-YYYY\', }">')
